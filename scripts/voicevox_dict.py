...
WORDS = [
    ...
    ("安全面", "アンゼンメン", 0),  # 「やすぜんめん」と誤読される
    ("何ですか", "ナンデスカ", 0),  # 「なにですか」→「なんですか」
    ("何でしょう", "ナンデショウ", 0),
    # --- 人名・学校名・チーム名など固有名詞(誤読されやすく、AIも読みを外しやすい) ---
    ("布袋", "ホテイ", 0),          # 布袋寅泰(高崎出身)。「ほたい」と誤読される
    ("花咲徳栄", "ハナサキトクハル", 0),  # 埼玉の高校。徳栄=とくはる(「とくえい」は誤り)
    ("前橋育英", "マエバシイクエイ", 0),
    ("健大高崎", "ケンダイタカサキ", 0),
    ("桐生第一", "キリュウダイイチ", 0),
    ("樹徳", "ジュトク", 0),        # 群馬・樹徳高
