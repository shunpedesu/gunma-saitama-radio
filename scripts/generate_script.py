...
# 話題の選び方（重要）
- 天気・気温・猛暑・熱中症・寒さなどの「天気ネタ」は、番組全体の【1割程度まで】に抑える。
  天気を回の主役にしない。扱う場合も、オープニングの軽い一言や合間のひとこと程度にとどめる。
- ニュースは【基本、明るい・前向きな話題（グッドニュース）】を優先して選ぶ。
  例: 地域のお祭り・イベント、新店/新商品/新スポット、受賞・達成・記録更新、季節の楽しみ、
  特産品やものづくり、人の頑張りや心温まる話題、観光・グルメなど。
- 事故・事件・災害・訃報・不祥事などのネガティブな話題は避ける（どうしても触れる場合もごく軽く、
  深追いや不安を煽る表現はしない）。
- その日のニュース候補が天気やネガティブ寄りに偏っているときは、無理に使わず、群馬・埼玉の
  ローカルあるある・食・温泉・観光・文化・歴史の明るい話題でふくらませてよい。
